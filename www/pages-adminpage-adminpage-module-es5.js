...
var AdminpagePage = /** @class */ (function () {
    ...
    AdminpagePage.prototype.reset = function () {
        // console.log(this.lineData2)
        // this.lineData = [...this.lineData2];
    };
    AdminpagePage.prototype.getUserRatingsByDate = function (project, team) {
        var _this = this;
    ...
    AdminpagePage.prototype.setButtonStatus = function () {
    ...
    AdminpagePage.prototype.logout = function () {
        var _this = this;
