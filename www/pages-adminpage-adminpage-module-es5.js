...
var AdminpagePageModule = /** @class */ (function () {
    function AdminpagePageModule() {
    }
    AdminpagePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_adminpage_page__WEBPACK_IMPORTED_MODULE_6__["AdminpagePage"]]
        })
    ], AdminpagePageModule);
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2FkbWlucGFnZS9hZG1pbnBhZ2UucGFnZS5zY3NzIn0= */"
...
var AdminpagePage = /** @class */ (function () {
    function AdminpagePage(router, _platform) {
        this.router = router;
        ...
        this.subtitle = 'Viewers per season for';
    ...
    AdminpagePage.prototype.ionViewDidEnter = function () {
        this.init();
        this.initAxes();
        this.drawAxes();
        this.drawChart();
    };
    AdminpagePage.prototype.init = function () {
        this.svg = d3_selection__WEBPACK_IMPORTED_MODULE_4__["select"]('#barChart')
            .append('svg')
            .attr('width', '100%')
            .attr('height', '100%')
    ...
    AdminpagePage.prototype.initAxes = function () {
        ...
        this.x.domain(this.barData.map(function (d) { return d.season; }));
        this.y.domain([0, d3_array__WEBPACK_IMPORTED_MODULE_6__["max"](this.barData, function (d) { return d.viewers; })]);
    };
    AdminpagePage.prototype.drawAxes = function () {
        this.g.append('g')
    ...
    AdminpagePage.prototype.drawChart = function () {
        var _this = this;
        this.g.selectAll('.bar')
            ...
            .attr('class', 'bar')
            .attr('fill', 'rgb(34, 167, 240)')
            .attr('x', function (d) { return _this.x(d.season); })
            .attr('y', function (d) { return _this.y(d.viewers); })
            .attr('width', this.x.bandwidth())
            .attr('height', function (d) { return _this.height - _this.y(d.viewers); });
    };
    AdminpagePage.prototype.initializeProject = function () {
        this.projects = [
            { id: 1, name: 'ISD' },
            { id: 2, name: 'Cognos' },
        ];
    };
    AdminpagePage.prototype.initializeTeams = function () {
        this.teams = [
...
//# sourceMappingURL=pages-adminpage-adminpage-module-es5.js.map